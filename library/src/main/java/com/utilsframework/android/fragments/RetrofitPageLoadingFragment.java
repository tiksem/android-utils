...
public abstract class RetrofitPageLoadingFragment extends RequestManagerFragment {
    ...
    private void load() {
        contentVisibilityManager = new LoadingContentVisibilityManager<List, Throwable>(getActivity()) {
            ...
            public int getContentLayoutId() {
                return RetrofitPageLoadingFragment.this.getContentLayoutId();
            }

            @Override
            public int getLoadingLayoutId() {
                return RetrofitPageLoadingFragment.this.getLoadingLayoutId();
            }

            @Override
            public int getRetryButtonId() {
                return RetrofitPageLoadingFragment.this.getRetryButtonId();
            }
            ...
            public int getNoConnectionView() {
                return RetrofitPageLoadingFragment.this.getNoConnectionView();
            }
        };
