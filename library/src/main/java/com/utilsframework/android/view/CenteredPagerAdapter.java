 ...
 * a {@link CentredViewPager}.  You will most likely want to use a more
 * specific implementation of this, such as
 * {@link android.support.v4.app.FragmentPagerAdapter} or
 * {@link android.support.v4.app.FragmentStatePagerAdapter}.
 *
 * <p>When you implement a CenteredPagerAdapter, you must override the following methods
 * at minimum:</p>
 * <ul>
 ...
 * </ul>
 *
 * <p>CenteredPagerAdapter is more general than the adapters used for
 * {@link android.widget.AdapterView AdapterViews}. Instead of providing a
 * View recycling mechanism directly CentredViewPager uses callbacks to indicate the
 * steps taken during an update. A CenteredPagerAdapter may implement a form of View
 ...
 * own Fragment.</p>
 *
 * <p>CentredViewPager associates each page with a key Object instead of working with
 * Views directly. This key is used to track and uniquely identify a given page
 * independent of its position in the adapter. A call to the CenteredPagerAdapter method
 * {@link #startUpdate(ViewGroup)} indicates that the contents of the CentredViewPager
 ...
 *
 * <p>A very simple CenteredPagerAdapter may choose to use the page Views themselves
 ...
 *
 * <p>CenteredPagerAdapter supports data set changes. Data set changes must occur on the
 ...
 * CentredViewPager will keep the current page active provided the adapter implements
...
public abstract class CenteredPagerAdapter {
     ...
     * required for a CenteredPagerAdapter to function properly.
     *
    ...
    /**
     * This method may be called by the CentredViewPager to obtain a title string
     ...
     * CentredViewPager's measured width from (0.f-1.f]
     *
